...
>
            ...
            <?php $headingContent = (function ($args) {
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! is_slot_empty($headingContent)): ?>
        <div><?php echo e($headingContent); ?></div>
    <?php else: ?>
    ...
    ?>
            ...
            <?php $actionsContent = (function ($args) {
                return function () use ($args) {
                    extract($args, EXTR_SKIP);
                    ob_start(); ?>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! is_slot_empty($actionsContent)): ?>
        <div class="fi-header-actions-ctn">
            <?php echo e($actionsContent); ?>
...
<?php /**PATH C:\Users\User\Desktop\WEB PROGRAMMING\Orders\inweb-test\vendor\filament\filament\resources\views/components/header/index.blade.php ENDPATH**/ ?>